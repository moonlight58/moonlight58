...
Lately, I’ve been diving into <strong style="color: white">Text User Interface (TUI)</strong> applications—especially building lightweight alternatives like a terminal-based Spotify client.<br><br>
